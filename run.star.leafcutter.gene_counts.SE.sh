...
$toolPath --genomeDir $index --readFilesIn $input1 --twopassMode Basic --quantMode GeneCounts --sjdbGTFfile $gtfreference --outSAMstrandField intronMotif --readFilesCommand zcat --outSAMtype BAM Unsorted --outFileNamePrefix  $outdir/${toolName}_$(basename ${input1%.*})_ >> $logfile 2>>$logfile

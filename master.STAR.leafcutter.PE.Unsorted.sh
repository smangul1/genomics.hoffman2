...
echo "/u/home/s/serghei/code/genomics.hoffman2/run.STAR.leafcutter.PE.Unsorted.sh ${pwd}/${line}_R1_001.fastq.gz ${pwd}/${line}_R2_001.fastq.gz ${line}.STAR.BAM">run.star.leafcutter.${line}.sh

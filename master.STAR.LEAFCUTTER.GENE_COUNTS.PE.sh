...
echo "/u/home/s/serghei/code/genomics.hoffman2/run.star.leafcutter.gene_counts.PE.sh ${pwd}/${line}_R1_001.fastq.gz ${pwd}/${line}_R2_001.fastq.gz ${line}.STAR.BAM">run.star.leafcutter.gene_counts.SE.${line}.sh
